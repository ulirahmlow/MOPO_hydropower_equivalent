...
With the given inflow data and detailed hydropower production or historical production 
## How to use
...
7. In this folder, you need this structure
  - Input
      - Price
...
A template is given in the configs folder
